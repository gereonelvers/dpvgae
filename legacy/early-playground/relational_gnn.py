...
"""
PyTorch Lightning GraphSAGE model build to predict paper venues in OBGN dataset
"""
class DataModule(LightningDataModule):
    ...
    def dataloader(self, mask: Tensor, shuffle: bool, num_workers: int = 2):
...
def main():
    seed_everything(42)
    datamodule = DataModule('../../process-datasets/OGB')
